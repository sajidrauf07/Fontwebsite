...
import { NAME_FAQ_ITEMS, NameFaqItem } from '@/data/nameData';

export default function NameFaqSection() {
    ...
    <section className="faq-v2-wrapper mb-12" id="faq">
      ...
      <div className="faq-v2-header">
        ...
        <h2 className="faq-v2-title">
          Preguntas Frecuentes sobre Letras para Nombres
        </h2>
      </div>

      <div className="faq-v2-list">
        {NAME_FAQ_ITEMS.map((item: NameFaqItem, idx: number) => {
