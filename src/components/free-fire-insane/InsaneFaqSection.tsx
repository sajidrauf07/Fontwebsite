...
export default function InsaneFaqSection() {
    ...
    <section className="faq-v2-wrapper mb-12" id="faq">
      ...
      <div className="faq-v2-header">
        ...
        <h2 className="faq-v2-title">
          Preguntas Frecuentes sobre Nombres Insanos para Free Fire
        </h2>
        <p className="faq-v2-subtitle">
          Respuestas claras sobre la creación, compatibilidad y uso de apodos insanos estilizados:
        </p>
      </div>

      <div className="faq-v2-list">
        {FREE_FIRE_INSANE_FAQ_ITEMS.map((item, idx) => {
